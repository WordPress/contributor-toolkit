...
If a pull request is checked out, this screen can save an unattributed backup but cannot send the combined work. Use **Back to ticket #NNNNN** or **Back to trunk** first. Edits you made while trying the PR stay on its local branch; returning prevents the PR author's commits from being submitted as yours.
