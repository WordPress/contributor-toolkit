...
// hook tests/unit/ipc-wiring.test.cjs uses for main.js — no production code changes
...
// same test as in tests/unit/ipc-wiring.test.cjs and for the same reason: requiring it
...
// start a download into the directory tests/unit/electron-node-version.test.cjs spawns
