...
function copyFixture() {
	...
	// The build script ships as .js.txt rather than .js. That was required when
	// these tests lived in a directory named `test/`, which `node --test` walked
	// wholesale — a fixture named .js was collected and executed as a test. From
	// tests/unit/ it no longer would be, but the extension stays: it costs one
	// rename here and it keeps the fixture inert under any discovery rule.
