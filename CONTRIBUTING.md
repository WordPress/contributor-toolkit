...
5. Open the PR and, when it is ready for review, comment `@coderabbitai review`; CodeRabbit reviews it against the same standard; optionally **assign Copilot** as a further reader.
